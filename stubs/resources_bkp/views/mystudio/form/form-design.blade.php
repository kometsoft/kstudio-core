...
@section('content')
    <div class="container-fluid p-0">
                                ...
                                @foreach ($initiate as $init)
                                    @foreach ($tableDetails as $tableDetail)
                                        @foreach ($tableDetail['htmlField'] as $field)
                                            @if ($init['column_name'] === $field['column_name'])
                                                            ...
                                                            <div class="input-group mb-3">
                                                                <span class="input-group-text">
                                                                    ...
                                                                    @elseif($field['html_input_type'] == 'date')
                                                                        <i class="ti ti-calendar align-middle d-inline">
                                                                        </i>
                                                                    @elseif($field['html_input_type'] == 'number')
                                                                        <i class="ti ti-square-1 align-middle d-inline">
                                                                        </i>
                                                                    @else
                                                ...
                                                @elseif($field['html_input_type'] == 'checkbox')
                                                    <div id="{{ $tableDetail['table_name'] }}{{ $field['column_name'] }}{{ $loop->iteration }}"
                                                        class="mb-3 hover-test" draggable="true"
                                                ...
                                                @elseif($field['html_input_type'] == 'radio')
                                                    <div id="{{ $tableDetail['table_name'] }}{{ $field['column_name'] }}{{ $loop->iteration }}"
                                                        ...
                                                        <div class="icon">
                                                            <div class="input-group mb-3">
                                                                <span class="input-group-text">
                                                                    <i class="ti ti-circle-check align-middle d-inline">
                                                                    </i>
                                                                </span>
                                                                <input type="text" class="form-control"
                                                                    value="{{ $field['html_input_type'] }}" disabled>
                                                    ...
                                                    {{-- for input field - hidden --}}
                                                @elseif($field['html_input_type'] == 'hidden')
                                                    <div id="{{ $tableDetail['table_name'] }}{{ $field['column_name'] }}{{ $loop->iteration }}"
                                                        class="mb-3 hover-test" draggable="true"
                                                        ondragstart="drag(event)" ondragover="noAllowDrop(event)">
                                                        ...
                                                        <div class="icon">
                                                            <div class="input-group mb-3">
                                                                <span class="input-group-text">
                                                                    <i class="ti ti-eye-off align-middle d-inline"> </i>
                                                                </span>
                                                                <input type="text" class="form-control"
                                                                    value="{{ $field['html_input_type'] }}" disabled>
                                                                <input type="text" class="form-control"
                                                        ...
                                                        <div class="getContent"
                                                            ...
                                                            data-column="{{ $field['column_name'] }}">
                                                            <x-forms.input
                                                                label="{{ $field['html_label'] }}({{ $field['html_input_type'] }})"
                                                                type="text"
                                                                placeholder="{{ $field['html_placeholder'] }}"
                                                                name="{{ $field['column_name'] }}" width="8">
                                                                <div class="float-end button_div mt-1 col-md-1">
                        ...
                        <div id="div2" ondrop="drop(event)" ondragover="allowDrop(event)">
                            @if (!empty($initiate))
                                @foreach ($tableDetails as $tableDetail)
                                    ...
                                    @foreach ($tableDetail['htmlField'] as $field)
                                        @foreach ($notinitiate as $notinit)
                                            @if ($notinit['column_name'] === $field['column_name'])
                                                @if ($field['html_input_type'] == 'text' ||
                                                    $field['html_input_type'] == 'email' ||
                                                    $field['html_input_type'] == 'file' ||
                                                    $field['html_input_type'] == 'date' ||
                            ...
                            @else
                                @foreach ($tableDetails as $tableDetail)
                                    <h4 ondragover="noAllowDrop(event)" class="mb-3">{{ $tableDetail['table_name'] }}
                                    </h4>
                                    @foreach ($tableDetail['htmlField'] as $field)
                                        @if ($field['html_input_type'] == 'text' ||
                                            $field['html_input_type'] == 'email' ||
                                        ...
                                        @elseif($field['html_input_type'] == 'hidden')
                                            <div id="{{ $tableDetail['table_name'] }}{{ $field['column_name'] }}{{ $loop->iteration }}"
                                                ...
                                                <div class="getContent"
                                                    ...
                                                    <x-forms.input
                                                        label="{{ $field['html_label'] }}({{ $field['html_input_type'] }})"
                                                        type="text" placeholder="{{ $field['html_placeholder'] }}"
                                                        name="{{ $field['column_name'] }}" width="8">
                                                        <div class="float-end button_div mt-1 col-md-1">
                                                            <button type="button" class="btn btn-sm btn-muted"
                                                                data-bs-toggle="modal"
        ...
        {{-- start store data for form properties --}}
        <form id="create-form" action="{{ route('form.storeForm', $form_id) }}" method="post">
            @csrf
                                ...
                                <div class="modal-body">
                                    <div class="mb-3 mandatory">
                                        ...
                                        <div class="form-check">
                                            <input type="hidden" name="properties[{{ $loop->iteration }}][mandatory]"
                                                value="No">
                                        ...
                                        <div id="MandatoryErrorMessage{{ $loop->iteration }}"
                                            ...
                                            <input name="properties[{{ $loop->iteration }}][mandatory_error_message]"
                                                type="text" class="form-control" value="Medan input ini wajib diisi.">
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input name="properties[{{ $loop->iteration }}][label]" type="text"
                                            class="form-control" value="{{ $field['html_label'] }}">
                                    </div>

                                    <div class="mb-3">
                                        <label for="" class="form-label">Place Holder</label>
                                        <input name="properties[{{ $loop->iteration }}][placeholder]" type="text"
                                            class="form-control" value="{{ $field['html_placeholder'] }}">
                                    </div>

                                    <div class="mb-3">
                                        <label for="" class="form-label">Table Name</label>
                                        <input name="properties[{{ $loop->iteration }}][table_name]" type="text"
                                            class="form-control" value="{{ $tableDetail['table_name'] }}" readonly>
                                    </div>

                                    <div class="mb-3">
                                        <label for="" class="form-label">Name</label>
                                        <input name="properties[{{ $loop->iteration }}][column_name]" type="text"
                                            class="form-control" value="{{ $field['column_name'] }}" readonly>
                                    </div>

                                    <div class="mb-3">
                                        <label for="" class="form-label">Field Type</label>
                                        <input name="properties[{{ $loop->iteration }}][field_type]" type="text"
                                            class="form-control" value="{{ $field['html_input_type'] }}" readonly>
                                    </div>
        ...
        {{-- end store data for form properties --}}

        <div class="float-end">
            <a href="{{ url()->previous() }}" class="btn btn-outline-primary me-2">Cancel</a>
            <button type="submit" onclick="getContents()" form="create-form" class="btn btn-primary">Save</button>
        </div>
...
@push('scripts')
    ...
    <script>
        // Make Content (input) on DIV1 sortable
        $(function() {
            $("#div1").sortable();
        });
    </script>
